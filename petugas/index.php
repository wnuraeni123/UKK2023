<?php 
 ...
 ?>
  ...
  <html>
    ...
    <body style="background:url(../img/apapa.jpg); background-size: cover;">
          ...
          <ul id="slide-out" class="sidenav sidenav-fixed">
              <li>
                  <div class="user-view">
                      ...
                      <a href="#user"><img class="circle" src="../img/mnsia.jpg"></a>
                      <a href="#name"><span class="black-text name"><?php echo ucwords($_SESSION['data']['nama_petugas']); ?></span></a>
                  </div>
              </li>
              <li><a href="index.php?p=dashboard"><font color="blue">Dashboard</font></a>
              <li><a href="index.php?p=pengaduan"><font color="blue">Pengaduan</font></a>
              <li><a href="index.php?p=respon"><font color="blue">Respon<font></a>
              <li>
                  <div class="divider"></div>
              </li>
              <li><a class="waves-effect" href="../index.php?p=logout"><font color="blue">Logout</font></a>
          </ul>
