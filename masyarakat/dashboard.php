<table class="responsive-table" border="6" style="width: 100%;">
	<tr>
		<td><h2 class="white-text">Tulis Laporan</h2></td>
		<td><h2 class="white-text">Daftar Laporan</h2></td>
	</tr>
	<tr>
			...
			<table border="11" class="responsive-table striped highlight">
				...
				<?php 
					...
					<tr>
						...
						<td><font color="white"><?php echo $r['nik']; ?></font></td>
						<td><font color="white"><?php echo $r['nama']; ?></font></td>
						<td><font color="white"><?php echo $r['tgl_pengaduan']; ?></font></td>
						<td><font color="white"><?php echo $r['status']; ?></font></td>
						<td>
							<a class="btn black modal-trigger" href="#tanggapan&id_pengaduan=<?php echo $r['id_pengaduan'] ?>">More</a> 
